...
def parseArgs(inp=''):
    ...
    parser.add_argument("-e","--edesc", type=str, help="Optional tab-delimited text file describing experiment.", default="ExptDescription.txt")
    parser.add_argument("-l","--ldesc", type=str, help="Optional tab-delimited text file describing library examined during experiment.", default="LibraryDescription.txt")
    parser.add_argument("-g","--g2orf", type=str, help="Optional tab-delimited text file translating systmatic (ORF) to standard gene names.", default="ORF2GENE.txt")
...
def main():
    inp=parseArgs()
    res=c2.parseAndCombine(inp.imdir,inp.edesc,inp.ldesc,inp.g2orf,inp.out,inp.fmt)
